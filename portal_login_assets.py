...
body.tema-portal-login .fundo-pagina--portal .fundo-pagina-video {
  ...
  z-index: 0;
  transform: scale(1);
  animation: portal-bg-breathe 16s ease-in-out infinite alternate;
}
...
.portal-fire-glow {
  ...
  background: radial-gradient(ellipse at 50% 60%,
    ...
    transparent 72%);
  filter: blur(18px);
  animation: portal-fire-pulse 3.6s ease-in-out infinite alternate;
}
...
.portal-fire-core {
  ...
  filter: blur(1px);
  animation: portal-fire-flicker 1.8s ease-in-out infinite alternate;
...
.portal-fire-wave {
  ...
  background: radial-gradient(ellipse at 50% 100%,
    ...
    transparent 70%);
  filter: blur(12px);
  animation: portal-fire-wave 4.5s ease-in-out infinite alternate;
  mix-blend-mode: screen;
}
